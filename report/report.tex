...
Οι παραπάνω μέθοδος \en FEM \gr για τον υπολογισμό του δυναμικού, όπως και αυτή για τον υπολογισμό 
της ενέργειας ανά μονάδα μήκους υλοποιήθηκε σε \en matlab. \gr
Δε θα αναφέρω εδώ λεπτομέρειες σε επίπεδο συναρτήσεων, υπάρχει αναλυτική εξήγηση με μορφή σχολίων στο αρχείο \en coaxial.m. \gr
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
      \centering
      \includegraphics[width=\textwidth]{coaxial_mesh_no_refine.pdf}
      \caption{}
...
\begin{figure}[h]
  ...
  \begin{subfigure}{0.45\textwidth}
      \centering
      \includegraphics[width=\textwidth]{capacitor_mesh_no_refine.pdf}
      \caption{}
...
\begin{figure}[h]
  ...
  \begin{subfigure}{0.45\textwidth}
      \centering
      \includegraphics[width=\textwidth]{coaxial_mesh.pdf}
      \caption{}
      \label{fig:coaxial_mesh_with_refines}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.45\textwidth}
      \centering
      \includegraphics[width=\textwidth]{capacitor_mesh.pdf}
      \caption{}
      \label{fig:capacitor_mesh_with_refines}
  \end{subfigure}
  \caption{}
  \label{}
\end{figure}
...
\begin{figure}[h]
  ...
  \begin{subfigure}{0.45\textwidth}
      \centering
      \includegraphics[width=\textwidth]{coaxial_field.pdf}
      \caption{Ομοαξονικό καλώδιο}
  ...
  \begin{subfigure}{0.45\textwidth}
      \centering
      \raisebox{0.6cm}{\includegraphics[width=\textwidth]{capacitor_field.pdf}}
      \caption{Πυκνωτής επίπεδων πλακών}
      \label{fig:second}
  \end{subfigure}
  \caption{Το αποτέλεσμα της μεθόδου \en FEM \gr για τα δύο προβλήματα. Με χρώμα απεικονίζεται το δυναμικό ενώ με τα βέλη το ηλεκτρικό πεδίο.}
