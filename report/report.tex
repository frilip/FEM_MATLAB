...
\[ W_e \approx \frac{1}{2} \epsilon  \sum_p \sum_{q}  \phi_p \phi_q   \sum_{t | p,q \in t} (b_ib_j + c_ic_j) A_e  \]
...
Υπολογίζεται η ενέργεια και η χωρητικότητα ανά μονάδα μήκους όπως προηγουμένως. Οι τιμές της χωρητικότητας ανά μονάδα μήκους 
για 0,1,2 και 3 \en refinements \gr είναι 
$50.3 \ pF/m$, $49.8 \ pF/m$, $49.6 pF/m$ και $49.56 \ pF/m$
...
$48.8 \ pF/m$, $49.6 \ pF/m$, $49.8 \ pF/m$ και $49.9 \ pF/m$
αντίστοιχα.
...
$\epsilon |\mathbf{E}|^2$ είναι παντού θετική, το ολοκλήρωμα θα αυξάνεται, όμως με φθίνων ρυθμό)
